		...
		stage("Deploy"){
			if(env.BRANCH_NAME == 'master'){
				lock('FitNesse') {
					...
					sshRemove remote: remote, path: '/data/tomcat/tomcat/data/group13.war', failOnError: false
					sshRemove remote: remote, path: '/data/tomcat/tomcat/data/group13', failOnError: false
					sshPut remote: remote, from: 'build/libs/group13.war', into: '/data/tomcat/tomcat/data/', failOnError: true
					echo 'Start server ...'
					...
					lock('FitNesse') {
						step([
							...
							options: [
								...
								"fitnesseTargetPage": "TestSuite.TestsuiteGroup13",
